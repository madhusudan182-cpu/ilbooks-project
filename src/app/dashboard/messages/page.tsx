...
const allConversations = [
  {
    ...
    messages: [
      ...
      { id: 7, text: "Also, can I retake the exam if I fail?", sender: currentUser.id, timestamp: '10:06 AM', status: 'sent' as const },
      { id: 8, text: "Yes, you can retake the exam. A fee is required for each attempt, but there is no limit to how many times you can try.", sender: 'ilbooks-admin', timestamp: '10:07 AM'},
    ],
    lastMessage: "Yes, you can retake the exam. A fee is required for each attempt...",
    timestamp: "10:07 AM",
    unread: 0,
  },
